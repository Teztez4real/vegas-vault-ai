...
══════════════════════════════════════════════════════════════
The steps are NOT independent checkboxes. Every data point must inform every other.

HOW THE DATA CONNECTS:
- Form + Pace/Ratings + H2H → the TRUE matchup edge
- Matchup edge + Line price → is the market right or wrong?
- Sharp money + Line movement + Public % → what the market KNOWS vs what it SHOWS
- Rest/B2B + Injuries + Psychology → how each team will actually show up
- All of the above TOGETHER → the play

BEFORE FINALIZING: "Do form, matchup, situational factors, psychology, AND sharp money all point the same direction?"
- YES → high confidence, real edge
- MOST agree, one contradicts → state the contradiction, adjust tier down
- Evenly split → Tier 3, pass
