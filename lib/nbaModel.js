...
MANDATORY MARKET EVALUATION — EVERY GAME:
Before picking a bet type, explicitly evaluate all three markets:

TOTAL FIRST — ask every game:
- What are both teams' offensive ratings vs opponent defensive ratings?
- Is this a playoff game? Playoff unders hit 54-56% — defensive intensity rises
- What is the pace of both teams? Slow + slow → UNDER. Fast + fast → OVER viable
- Both teams averaging under 105 points last 5? → UNDER lean
- Both teams averaging over 115 points last 5? → OVER lean
- If 3+ factors point same direction → TOTAL is the play

SPREAD EVALUATION — ask every game:
- Is one team averaging 10+ point wins in last 10?
- Is there a significant talent/matchup mismatch?
- Does the favorite own this opponent by large margins in H2H?
- Is the underdog competitive enough to keep it within the number?
- If dominant team → spread. If underdog is live → +ATS underdog.

ML — only when edge is real but margin is genuinely uncertain. ML is the fallback, not the default.
