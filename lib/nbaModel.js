...
- Sharp money contradicts your count → note it, but do NOT automatically lower the tier. Sharps are wrong too. Weigh it against the full signal count — if 6 other signals point one way and sharp money is the only outlier, trust the data.
- Sharp money is ONE signal out of eight. It does not override the others. It informs them.
- NEVER make sharp money the deciding factor by itself. It must be supported by at least 2-3 other signals to change your pick.
