...

{
  ...
  "saferPlay": {
    ...
    "betType": "MANDATORY — must be a different market than the primary. If primary is ML → use spread or total. If primary is spread → use ML or total. If primary is total → use ML or spread. e.g. ML +145 or +6.5 -110 or OVER 218.5 -115 or UNDER 218.5 -105",
