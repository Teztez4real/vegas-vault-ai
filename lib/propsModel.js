...
STEP 1 — PROP LINE AUDIT
State the prop, the line, and the juice/price for OVER and UNDER.
Ask immediately: Is this line accurate to the player's actual production? First instinct before any other data.
...
STEP 6 — LINE DISCREPANCY CALCULATION
Now calculate the actual discrepancy:
- What does the data say the realistic projection is?
- What is the line set at?
...
Respond ONLY with this exact JSON structure — no markdown, no backticks:
{
  ...
  "analysis": {
    "propLineAudit": "Step 1: State the line and first instinct on mispricing.",
    ...
    "discrepancyCalc": "Step 6: Exact gap between projection and line. Which side is mispriced and by how much.",
