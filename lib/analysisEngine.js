...
6b. ⚡ NARRATIVE-OUTRUNS-REALITY PROPAGANDA (a category with MANY forms — stay alert for all of them, not just one template): This is media/broadcast language that oversells a small or cherry-picked slice of reality as if it were the full picture. The injury-return case is just ONE example: "Woodruff (2-1, 2.59 ERA) has been nearly flawless in his first two outings since missing nearly two months with shoulder inflammation" — glowing superlatives ("nearly flawless," "dominant," "vintage form") built on only 1-3 recent appearances. But watch for OTHER forms of the same underlying pattern too, including:
   ...
   * The common thread across all forms: superlative/emotional language + a small or selectively-framed sample (or a historical stat repeated out of context) + a narrative arc that's more compelling than it is statistically supported for THIS SPECIFIC game.
...
Return JSON:
{
  ...
  "propagandaCheck": "What is the public narrative and is it supported by data? ALSO explicitly check for narrative-outruns-reality propaganda — ANY form of a story (small-sample hype, injury-return framing, hot-rookie buzz, revenge-game angle, historical never-won/never-lost streak framing, etc.) doing more work than the actual evidence supports. If present, name the specific form you found — this pattern favors the opponent ~9/10.",
...
Return JSON:
{
  ...
  "propagandaCheck": "What is the public narrative and is it hype or reality? ALSO explicitly check for narrative-outruns-reality propaganda — ANY form of a story outrunning the evidence (small-sample hype, injury return, hot streak, system-change bounce, etc.). If present, name the specific form — this pattern favors the opponent ~9/10.",
...
Return JSON:
{
  ...
  "counterValid": true or false,
  "passReason": "If passing, why. If playing, null.",
  "propagandaCheck": "Public narrative vs reality. ALSO explicitly check for narrative-outruns-reality propaganda — ANY form of a story outrunning the evidence (small-sample hype, injury return, hot streak, historical never-won/never-lost streak framing, etc.). If present, name the specific form — this pattern favors the opponent ~9/10.",
