...
${isVegas ? `
VEGAS SLOT — YOUR ONLY JOB IS TO FIND THE SCAM. IT IS HIDING SOMEWHERE IN THIS GAME.

Hunt through every layer in this order. The scam could be in any one of these:

1. THE ML SCAM — Check first:
Is the ML a public trap? Is the favorite priced on name/narrative rather than current reality?
Is the public hammering one side because of recent results, media hype, or star power — but the data doesn't support the price?
If the ML looks like a public play (i.e. the obvious side that everyone is on), SKIP it as the scam vehicle and look deeper.

2. THE RUN LINE/SPREAD SCAM — Check if ML is public:
If the ML side is the obvious public play, is the scam in the run line instead?
Can the underdog cover +1.5 even if they lose? Is the favorite being bet to win but unlikely to cover -1.5?
Is the underdog +1.5 at near-even money a trap that the sharp side already identified?
If the run line also looks like a public play, move to the total.

3. THE TOTAL SCAM — Check if spread is public:
Is the over/under being hammered by the public based on offensive reputation rather than today's pitching and conditions?
Wind direction, temperature, umpire tendency, park factor — is the public ignoring these?
Is the public betting the over on an offensive team without checking the ERA of today's starter?

4. THE PITCHING SCAM (MLB — always check):
The ace tag is the most common scam in baseball. Public sees "Ace vs TBD" and hammers.
- Is the ace 1-4 in his last 5 starts despite a "good" ERA?
- Does this lineup specifically destroy his pitch mix or approach?
- Is the "weak" starter actually better in current form than advertised?
- Is the public sleeping on a pitcher who has dominated this opponent historically?

5. THE FORM SCAM:
Public always overreacts to the last game. A blowout yesterday means nothing for today.
- Is the hot team in a regression spot? Series finale, back-to-back, emotional letdown?
- Is the cold team about to bounce back? Losing close games, tough schedule, now facing weaker competition?
- Bullpen fatigue from yesterday — which team threw 4+ relievers last night?

6. THE PROPAGANDA SCAM:
What is ESPN/media/social media pushing? That narrative is almost always inflating one side.
- Big market team getting national TV love? That's a price inflation signal.
- Player narrative ("he's been on fire") driving money without checking the underlying splits?
- Is the public following last night's box score instead of today's matchup?

7. THE SITUATIONAL SCAM:
- Series finale: public bets the series leader, scam is on the desperate team
- Revenge game: team embarrassed last meeting plays with extra edge
- Travel: west coast team playing day game after red-eye flight
- Divisional familiarity: these teams know each other — chalk is often a trap

THE RULE: Keep hunting until you find where the scam is hiding. If you can't find it after checking all seven layers — and ONLY then — consider whether this is truly a pass.

MANDATORY OUTPUT: State (1) WHERE the scam is hiding, (2) WHY the public is wrong, (3) WHY the other side is actually correct.` : `
...
Hunt all seven. State WHERE the scam is, WHY the public is wrong, WHY the other side is correct.` : `PUBLIC SLOT: Go with the better team. Still scan for fatigue, matchup, and narrative scams.`}
...
Hunt all seven. State WHERE the scam is, WHY the public is wrong, WHY the other side is correct.` : `PUBLIC SLOT: Go with the better team. Still scan for QB, injury, weather, and situational scams.`}
...
${isVegas ? `VEGAS SLOT — hunt the scam: (1) ML trap — higher-ranked player overpriced on ranking not current form? (2) Spread scam — favorite expected to win but not dominate? (3) Total scam — serve style or surface creates scoring edge public missed? (4) Surface scam — player's surface record vs reputation? (5) Fatigue scam — long 3-set match yesterday, public ignores rest disadvantage? (6) Propaganda scam — media favorite vs player quietly in better form? Find it and state WHY the public is wrong.` : `PUBLIC SLOT: Go with the better player on this surface unless data contradicts.`}
...
${isVegas ? `VEGAS SLOT — hunt the scam through every layer: (1) ML trap — is the favorite overpriced on reputation? (2) Spread scam — underdog covering even in a loss? (3) Total scam — pace or defense the public ignored? (4) Roster scam — key injury the public missed? (5) Fatigue scam — B2B or heavy minutes? (6) Star matchup scam — the star getting a favorable/unfavorable matchup the market missed? Find it and state WHY the public is wrong.` : `PUBLIC SLOT: Go with the better team unless data contradicts.`}
