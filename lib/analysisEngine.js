...
Series Context: ${stage1Data.seriesContext || 'N/A'} ${stage1Data.seriesContext?.includes('FINALE') ? 'SERIES FINALE - mandatory scam play analysis' : ''}. If series data is missing, use your knowledge to determine the actual game number in this series.
Hitter/Lineup: ${stage1Data.hitterLineup || 'N/A'}
...
MONEYLINE: Away ${game.awayML || 'N/A'} / Home ${game.homeML || 'N/A'}
SPREAD: ${game.spread || 'N/A'} | TOTAL: ${game.total || 'N/A'}
PLAYOFF CONTEXT: ${game.playoffContext || 'N/A'}

IMPORTANT: If team records show 0-10 or clearly invalid data, those are API failures — ignore them and use your current knowledge of both teams' actual performance this season and in these playoffs.
