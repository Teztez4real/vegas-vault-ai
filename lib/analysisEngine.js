...
Run Line: ${game.spread || 'N/A'} Away ${game.awaySpreadPrice || '-110'} Home ${game.homeSpreadPrice || '-110'}
...
Series Context: ${stage1Data.seriesContext || 'N/A'} ${stage1Data.seriesContext?.includes('FINALE') ? '⚠️ SERIES FINALE — mandatory scam play analysis' : ''}
Hitter/Lineup: ${stage1Data.hitterLineup || 'N/A'}
