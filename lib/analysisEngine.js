...
6b. ⚡ SMALL-SAMPLE HYPE PROPAGANDA (a distinct, specific pattern — not just general narrative/pricing inflation): Watch for beat-writer/media language that describes a player in GLOWING, SUPERLATIVE terms — "nearly flawless," "dominant," "lights out," "looks like his old self," "vintage form" — based on only a HANDFUL of recent appearances (1-3 starts), especially right after returning from injury or a slump. Example: "Woodruff (2-1, 2.59 ERA) has been nearly flawless in his first two outings since missing nearly two months with shoulder inflammation" — that is this exact pattern.
   * THIS IS A STRONG, SPECIFIC RULE: when you see this kind of small-sample hype language about a player, the OPPONENT wins roughly 9 times out of 10. The glowing narrative is outrunning the actual body of evidence — two good starts doesn't erase months of rust or an underlying injury, and the market/public overreacts to the recency and the story, not the full picture.
   * This is DIFFERENT from the general propaganda check above (which is about a narrative inflating a team's price/perception broadly). This is a specific, mechanical tell: superlative language + a tiny sample size + (usually) a recent injury/slump return. When those elements are present together, treat it as a HIGH-VALUE red flag against the hyped player's team — or equivalently a green flag for the opponent — separate from and in addition to the general narrative check.
   * Do not confuse this with a player who has a genuinely long track record of excellence — this pattern is specifically about a SMALL, RECENT sample being extrapolated into a bigger story than the data supports.
...
Return JSON:
{
  ...
  "propagandaCheck": "What is the public narrative and is it supported by data? ALSO explicitly check for small-sample hype propaganda — glowing/superlative language ('nearly flawless', 'dominant', 'looks like his old self') about a player based on only 1-3 recent appearances, especially after an injury return. If present, name it explicitly — this specific pattern favors the opponent ~9/10.",
...
7b. ⚡ SMALL-SAMPLE HYPE PROPAGANDA (a distinct, specific pattern): Watch for media language describing a player in GLOWING, SUPERLATIVE terms — "looks like his old self," "explosive," "back to dominant form" — based on only a HANDFUL of recent games, especially right after returning from injury. This is a STRONG rule: when you see this specific pattern (superlative hype + tiny sample + recent injury/slump return), the OPPONENT wins roughly 9 times out of 10 — a couple of good games doesn't erase real rust, and the market overreacts to the story. Treat this as a high-value red flag against the hyped player's team, distinct from general narrative/price inflation.
...
Return JSON:
{
  ...
  "propagandaCheck": "What is the public narrative and is it hype or reality? ALSO explicitly check for small-sample hype propaganda — glowing language about a player based on only a couple recent games, especially after an injury return. If present, name it — this pattern favors the opponent ~9/10.",
...
7b. ⚡ SMALL-SAMPLE HYPE PROPAGANDA (a distinct, specific pattern): Watch for media language describing a player (QB, star skill player) in GLOWING, SUPERLATIVE terms — "looks like his old self," "dominant," "fully healthy and explosive" — based on only 1-2 recent games, especially right after returning from injury. This is a STRONG rule: when you see this specific pattern (superlative hype + tiny sample + recent injury return), the OPPONENT wins roughly 9 times out of 10 — a couple of good games doesn't erase real rust, and the market overreacts to the story. Treat this as a high-value red flag against the hyped player's team, distinct from general narrative/price inflation.
...
Return JSON:
{
  ...
  "counterValid": true or false,
  "passReason": "If passing, why. If playing, null.",
  "propagandaCheck": "Public narrative vs reality. ALSO explicitly check for small-sample hype propaganda — glowing language about a player based on only 1-2 recent games, especially after an injury return. If present, name it — this pattern favors the opponent ~9/10.",
