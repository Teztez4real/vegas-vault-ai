...
Return JSON:
{
  ...
  "analysis": {
    "_INSTRUCTION": "CRITICAL — every field below must be REASONING, not a restated fact dump. Don't just report 'Team X is 7-3 in last 10' — explain what that means combined with at least one other factor and why it matters for THIS bet. Connect at least two data points into a single inferential claim per field (e.g. 'The bullpen's 5.80 ERA over two weeks compounds with tonight's day game after a night game, which is why the total is live despite a modest line' — not 'bullpen ERA is 5.80, schedule is a getaway day'). If a field has nothing meaningful to connect, say so briefly rather than padding with disconnected stats.",
    "priceVsDataAudit": "Is the line justified by the data? Explain the reasoning, don't just restate the price and the data side by side.",
    "matchupFoundation": "Who is better in this specific matchup today, and WHY — connect the strongest 2-3 factors into one judgment, not a list",
    "recentForm": "What the recent form trend actually means for tonight's matchup specifically — not just the L5/L10 numbers restated",
    "headToHead": "Whether the H2H history is actually predictive here or just noise — explain why, don't just report the record",
    "pitching": "Pitching matchup summary. The vs-opponent data provided is already aggregated across the pitcher's last 6 seasons (career-spanning, not season-only) — trust it. A genuine 0-start result is real (young pitcher, recent call-up, true first meeting) and should be stated plainly, not assumed to be missing data. Only flag it as possibly incomplete if something else suggests otherwise (e.g. a long-tenured veteran against a frequent divisional opponent). Connect the pitching matchup to what it actually means for tonight's outcome, not just a stat recitation.",
    "hitterLineup": "Which specific lineup advantage actually matters for this game and why — not a generic rundown of both lineups",
    "seriesContext": "How the series situation actually changes tonight's incentives/likely approach — not just 'where we are in the series'",
    "situational": "The single strongest psychological/situational factor and why it's likely to actually affect tonight's game, not a checklist of possible factors",
    "trellRule": "Active or inactive — and if active, explain the actual reasoning for why it applies here, not just the rule name",
    ...
    "propaganda": "What the public is wrong about and why the data contradicts the narrative — a real argument, not just stating the narrative exists",
    "scamPlay": "${isVegas ? 'Why it looks wrong AND why it is actually correct — full reasoning chain' : 'N/A — public slot'}",
    "gameScript": "How this game is likely to play out and why that script favors this specific bet",
    "marketLogic": "Why this specific market beats the alternatives — the actual comparison/reasoning, not just the conclusion",
