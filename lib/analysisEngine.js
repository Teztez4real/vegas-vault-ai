...
Return JSON:
{
  ...
  "injuries": "MANDATORY for MLB: list any IL players, day-to-day players, or key absences for both teams. If none confirmed, state 'No significant injuries reported'",
  "weather": "MANDATORY for MLB: temperature, wind speed and direction, precipitation. State how it affects the game (blowing out = OVER lean, cold = UNDER lean, etc)"
