...
FIND THE SCAM. BET IT.` : `PUBLIC SLOT — YOU ARE LOOKING FOR THE EXPECTED OUTCOME.
The public slot means you expect the expected to happen. You are looking for anything that STANDS OUT — a clear edge that confirms or adjusts the expected outcome.

In a public slot:
- If the better pitcher is on the mound, EXPECT him to do well. Good pitchers are expected to perform.
- Back the expected outcome UNLESS the data actively contradicts it.
- The bar to go AGAINST the expected outcome is high — you need a specific, concrete reason.
- Compare price to information: is the line fair for what the data shows? Is there value?`}
...
KEEP IT SIMPLE:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
- Overanalyzing causes losing plays. Identify the clearest, most specific edge.
- If no clear edge exists after checking everything → PASS. Most games should be PASS.
- One strong reason beats five weak ones every time.
