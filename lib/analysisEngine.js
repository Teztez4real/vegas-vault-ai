...
Return JSON:
{
  ...
  "scamLayer": "${isVegas ? 'Which layer the scam was found in (PITCHING/ML/RUN_LINE/TOTAL/FORM/PROPAGANDA/SITUATIONAL/BULLPEN/PARK)' : 'N/A'}",
...
Return JSON:
{
  ...
  "analysis": {
    ...
    "priceVsDataAudit": "Is the line justified by the data? Is xFIP/SIERA diverging from ERA in a way that makes the price wrong? Explain the reasoning.",
    ...
    "seriesContext": "How the series situation actually changes tonight's incentives/likely approach",
