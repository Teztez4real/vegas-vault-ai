...
PASS if:
- Both teams are reasonably matched and line looks fair
- Only reason to bet is recency bias or public narrative without data support
- Coin flip game (juice makes these losing plays)
- Cannot state ONE specific concrete reason the line is wrong
...
PASS if: game is close to a coin flip, can't name one specific reason line is wrong, manufacturing reasons to play.
