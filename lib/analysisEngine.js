...
Series Context: ${stage1Data.seriesContext || 'N/A'} ${stage1Data.seriesContext?.includes('FINALE') ? '⚠️ SERIES FINALE — mandatory scam play analysis' : ''} — IMPORTANT: If series data is missing or shows default values, use your knowledge of the current ${game.sport} schedule to determine what game number this is in the series and what the series record is.
Hitter/Lineup: ${stage1Data.hitterLineup || 'N/A'}
