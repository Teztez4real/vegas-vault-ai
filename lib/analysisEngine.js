...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
MANDATORY STORYLINE SEARCH (USE WEB SEARCH):
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Before judging the edge, do a thorough, current web search to uncover the STORYLINE around this specific game today. The market prices storylines — find the narrative, then measure it against the price and the line movement. Search for:
- Beat-writer and local coverage for BOTH teams today
- What national / betting media is saying about this game (the talking points)
- Injury, lineup, bullpen, or starter news that just broke (more recent than the data above)
- Revenge angles, milestone chases, manager/clubhouse drama, slump/streak narratives
- Public betting sentiment — who the public is loading up on and WHY
- Any "trap game," "letdown spot," "must-win," or "statement game" framing being pushed
- Weather or park news being talked about for today specifically

THEN CROSS-REFERENCE THE STORYLINE AGAINST THE MARKET — this is the whole point:
1. PRICING: Does the price match the storyline, or has the narrative inflated one side beyond what the matchup justifies? A loud positive story usually means that side is overpriced — value is often on the quiet side.
2. LINE MOVEMENT: Does the movement CONFIRM the storyline or CONTRADICT it?
   - Line moving WITH the popular story = public money chasing the narrative (often the fade).
   - Line moving AGAINST the popular story = sharp money fading the narrative (follow the sharps).
   - A storyline screaming one way while the line moves the other is one of the strongest scam signals there is.
3. THE EDGE IS THE GAP: When the storyline and the actual matchup/data disagree, the storyline is usually what's wrong — that gap is the edge. When storyline, data, and line movement ALL agree, that's a confirmed lean.

State the storyline you found and exactly how it compares to the price and line movement. If web search is unavailable or returns nothing useful, say so explicitly and fall back to the narrative implied by the data — do not invent a storyline.
`;
...
${game.totalsProjection?.available ? `
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
INDEPENDENT TOTALS PROJECTION (quantitative model — a SIGNAL, not a verdict):
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
${game.totalsProjection.detail}
Projected: ${game.totalsProjection.projectedTotal} | Vegas: ${game.totalsProjection.vegasTotal} | Gap: ${game.totalsProjection.gap} (${game.totalsProjection.leaning}, ${game.totalsProjection.band})
Drivers: away ~${game.totalsProjection.factors.awayRuns}R / home ~${game.totalsProjection.factors.homeRuns}R | SP rates ${game.totalsProjection.factors.awaySPrate}/${game.totalsProjection.factors.homeSPrate} | wRC+ ${game.totalsProjection.factors.awayWRC}/${game.totalsProjection.factors.homeWRC} | park ${game.totalsProjection.factors.park}x | wind ${game.totalsProjection.factors.wind}x

HOW TO USE THIS PROJECTION:
- This is an INDEPENDENT quantitative read built from pitching rates (SIERA/FIP), team wRC+, park, and wind. Treat it as one more analyst at the table — weigh it like you weigh line movement or storyline.
- A gap of 2+ runs (STRONG) that AGREES with your matchup read is a powerful total signal — strong Tier 1/2 lean on the total.
- A gap of 1-2 runs (LEAN/MODERATE) only becomes a play when 3+ matchup factors point the SAME direction as the projection (ace the public is sleeping on, wind amplifying the under, lineup missing its cleanup hitter, etc.).
- A gap under 1 run = the projection has no edge; defer entirely to your read.
- CRITICAL: This number does NOT override your scam detection or pass discipline. If the projection screams a big edge but the market priced the total that way ON PURPOSE (taxed bullpens, a wind shift everyone's ignoring, a gutted lineup), the psychology read wins — that's a PASS. A pure number can walk into a scam; you exist to catch it.
- If the projection DISAGREES with your read, that disagreement is information — investigate which one is wrong before finalizing.` : ''}
