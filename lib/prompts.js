...
- Wind 15mph+ out + hitter-friendly umpire = high-scoring game → run line more risky, lean ML
- Wind 15mph+ in + pitcher-friendly umpire = low-scoring, close game → ML or +1.5
- Rain/cold at outdoor park = pitcher advantage, tighter game → lean ML
- Dome = weather irrelevant
...
Always choose the BEST play — not automatically ML. The run line is frequently the sharpest play in baseball and is underused by the public.
