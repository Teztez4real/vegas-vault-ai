...
ESPN H2H ANALYSIS:
${gameData.espnH2H || 'Cross-reference ESPN.com for series history'}

COVERS.COM H2H & ATS HISTORY:
${gameData.coversH2H || 'Cross-reference covers.com for ATS and SU series history'}
...
ESPN H2H: ${gameData.espnH2H || 'Cross-reference ESPN.com for H2H history'}
COVERS.COM H2H & ATS: ${gameData.coversH2H || 'Cross-reference covers.com for H2H and ATS history'}
