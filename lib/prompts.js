...
If you can't clearly identify which of (a-e) applies — PASS.
...
- When in doubt: set false. The system will re-analyze throughout the day.
  ...
  "saferPlay": {
    "pick": "Team name or OVER/UNDER for the safer play",
    "betType": "MANDATORY — must be a different market than the primary. If primary is ML → use run line or total. If primary is run line → use ML or total. If primary is total → use ML or run line. e.g. ML +145 or +1.5 -110 or OVER 8.5 -115 or UNDER 8.5 -105",
    "reasoning": "One sentence — why this is the safer option"
  }
}`;
}
...

{
  ...
  "saferPlay": {
    "pick": "Team name or OVER/UNDER for the safer play",
    "betType": "MANDATORY — must be a different market than the primary. If primary is ML → use spread or total. If primary is spread → use ML or total. If primary is total → use ML or spread. e.g. ML +145 or +1.5 -110 or OVER 8.5 -115 or UNDER 8.5 -105",
    "reasoning": "One sentence — why this is the safer option for clients who want less risk"
  }
}`;
}
...
Respond in this EXACT JSON format with NO extra text:
{
  "summary": {
    ...
    "finalVerdict": "1-2 plain sentences. State the play and the single strongest reason. Simple enough for anyone to read and act on immediately.",
    "saferPlay": {
      "pick": "Team name or side for the safer play",
      "betType": "e.g. ML +145 or +1.5 -110 or UNDER 8.5 -115",
      "reasoning": "One sentence — why this is the safer option for clients who want less risk"
    }
  }
}`;
