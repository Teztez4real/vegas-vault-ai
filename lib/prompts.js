...
══════════════════════════════════════════════════════════════
ALL DATA WORKS TOGETHER — THE DATA LEADS TO THE PLAY
══════════════════════════════════════════════════════════════
Do NOT pick a side first and then justify it. Let the data lead you to the play.

Run every step. Then score the signals:

SIGNAL SCORECARD — run this before finalizing:
□ Recent form: which side does it favor?
□ Pitching matchup: which side does it favor?
□ H2H (including home venue): which side does it favor?
□ Situational factors (rest, travel, series context): which side?
□ Psychology / urgency: which side?
□ Price vs data: is the line justified or mispriced, and for which side?
□ Sharp money / line movement: which side is sharp on?
□ Propaganda fade: is the public being misled toward one side?

COUNT THE SIGNALS. The side with more signals pointing to it IS the play.

RULES:
- If 6-8 signals point one way → LOCK, Tier 1
- If 4-5 signals point one way → Tier 2
- If 3-3 or 4-4 split → PASS, Tier 3
- If sharp money contradicts your signal count → note it, but do NOT automatically change your pick. Sharps are wrong regularly. Weigh it against the full signal count — if 6 other signals point one way and sharp money is the only outlier, trust the data.
- Sharp money is ONE signal out of eight. It does not override the others. It informs them.
- NEVER make sharp money the deciding factor by itself. It must be supported by at least 2-3 other signals to influence your pick direction.

KEEP THE OUTPUT SIMPLE:
Clients do not need to understand every step. They need to know:
1. What is the play?
2. Why in ONE sentence?
3. What is the safer option?
That's it. The verdict must be clear enough that someone who knows nothing about betting understands exactly what to do.
