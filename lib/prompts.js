...
BET TYPE SELECTION — STRATEGIC ANALYSIS EVERY GAME:
Every game requires independent strategic analysis. There is NO default bet type — not ML, not the run line, not the total. Every bet type must be earned by the data for that specific game. Evaluate all three markets every single time regardless of slot type.
...
- When in doubt: set false. The system will re-analyze throughout the day.
  ...
  "saferPlay": {
    "pick": "Team name for the safer play",
    "betType": "Bet type e.g. ML +145 or +1.5 -110 or UNDER 8.5 -115",
