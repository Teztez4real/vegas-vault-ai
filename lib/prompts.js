...
Classify as Close (1-2 run diff → ML or +1.5), Blowout (big mismatch → -1.5), or Controlled (one team leads but not dominant → ML).
Also factor WEATHER and UMPIRE:
- Wind 15mph+ out + hitter-friendly umpire = high-scoring game, leans OVER
- Wind 15mph+ in + pitcher-friendly umpire = low-scoring game, leans UNDER
- Rain/cold at outdoor park = pitcher advantage
