...
- Run line price is too steep relative to the evidence

RUN LINE (-1.5 / +1.5) — signals that point here:
- Favorite averaging 3+ run wins in last 10
- Significant pitching mismatch (ace vs weak starter)
- Favorite owns this opponent by large margins in H2H
- Underdog's offense rarely keeps games close → take the favorite -1.5
- Underdog is competitive, games tend to stay within a run → take +1.5

TOTAL (OVER/UNDER) — signals that point here:
- Both starters' recent ERAs: both under 3.50 → UNDER lean. Both above 4.50 → OVER lean
- Park factor: hitter-friendly park → OVER lean. Pitcher-friendly → UNDER lean
- Wind: 10mph+ blowing out → OVER lean. Blowing in → UNDER lean
- Temperature: under 60°F → UNDER lean
- Umpire over/under tendency
- Both offenses: both averaging 4+ runs/game last 10 → OVER viable. Both under 3.5 → UNDER viable

PICK THE MARKET WHERE THE EDGE IS CLEAREST. If multiple markets have edges, pick the one with the strongest signal. Do not default to ML just because it feels safer — every market is equally valid. A slate should have a mix of MLs, run lines, and totals based on what each individual game's data supports.
