...
FINALIZATION RULES:
- Tier 1 LOCK + HIGH confidence + all data available → readyToFinalize: true
- Tier 2 + complete data → readyToFinalize: true
- Tier 3 / PASS / missing key data → readyToFinalize: false
