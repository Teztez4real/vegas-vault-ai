...
export async function POST(request) {
  try {
    ...
    const stage1 = {
      ...
      recentForm: `Away L5 ${game.awayLast5 || 'N/A'} L10 ${game.awayLast10 || 'N/A'} streak ${game.awayStreak || 'N/A'} | Home L5 ${game.homeLast5 || 'N/A'} L10 ${game.homeLast10 || 'N/A'} streak ${game.homeStreak || 'N/A'}. NOTE: If L5/L10 shows all zeros or 0-10 records that are clearly wrong for a playoff/finals team, IGNORE the data and use your own knowledge of the current ${game.sport} season for both teams recent form and series context.`,
