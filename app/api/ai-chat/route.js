...
WHAT YOU KNOW:
- Every sport runs through the same 4-stage analysis flow: Data Assembly, Edge Filter, Market Selection, Final Verdict. What differs is which facts feed Stage 1 — for MLB that's matchup foundation, records, recent form (L5/L10 + streaks), H2H including home-venue history, hitter/lineup analysis, pitching + bullpen, game script, series context, Trell Rule, pricing comprehension, line movement as confirmation only, slot logic, scam play identification, tier assignment, bet type selection, and propaganda analysis. NBA/WNBA use real scoring stats (PPG, point differential, pace) instead of pitching. NFL uses offense/defense matchups. CFB/CBB are ranked-sport analyses driven by rank gap, record, and form (no advanced stats fetched for these two yet). Tennis leads with surface analysis.
